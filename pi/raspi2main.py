# Since there was an issue with using Torch with Raspberry Pi Zero, and Raspberry Pi Zero 2 had an issue with the i2c,
# the most sensible solution was to use two raspberry pis, in order to utilize the publish and subscribe method
# as well as have higher processing power to run the model
#ADDESSES OF TOF NOT VOTTRVT FIXED FIRST NEED TO CONNECT 2ND FIRST TO FIX ADDRESS
import requests
...
def on_message(mqttc, obj, msg):
    ...
    mqttc.publish("VirtualTopic/test", json.dumps(sensor_data), qos=2)  
